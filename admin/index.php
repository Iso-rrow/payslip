				...
				<div id="kt_header" class="header header-bg">
					...
					<div class="container-fluid">
						...
						<div class="topbar d-flex align-items-stretch">
							...
							<!--begin::Item-->
							<div class="d-flex align-items-center">
								<a href="index.html" class="btn btn-icon btn-color-white btn-active-color-primary border-0 me-n3" data-bs-toggle="tooltip" data-bs-placement="left" title="Return to launcher">
								...
								<div class="mh-375px scroll-y me-n7 pe-7">
									...
									<div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="2">
										...
										<div class="d-flex align-items-center">
											...
											<!--begin::Details-->
											<div class="ms-5">
												<a href="#" class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2"><?php echo htmlspecialchars($_SESSION = 'user_name') ?></a>
												<div class="fw-semibold text-muted">max@kt.com</div>
											</div>
											<!--end::Details-->
										</div>
