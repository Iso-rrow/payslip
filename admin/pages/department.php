...
// Fetch departments and their roles
$query = "
    SELECT d.id AS dept_id, d.name AS department, r.name AS role
    FROM departments d
...
<?php if (isset($_GET['success'])): ?>
    <div class="alert alert-success alert-dismissible fade show m-4" role="alert">
        <?= $_GET['success'] === 'department' ? ' Department added successfully!' : ' Role added successfully!' ?>
...
<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack flex-wrap mb-5">
    <div class="page-title d-flex flex-column me-5 py-2">
        <span class="text-dark fw-bold fs-3 mb-0"><?= htmlspecialchars($pages) ?></span>
    </div>
    ...
    <div class="d-flex flex-stack mb-5 gap-4">
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-light-primary btn-sm me-3" data-bs-toggle="tooltip" title="Coming Soon">
                <i class="ki-duotone ki-filter fs-6"></i> Filter
            </button>
            <button class="btn btn-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#addDepartmentModal">
                <i class="ki-duotone ki-plus-circle fs-6"></i> Add Department
            </button>
            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addRoleModal">
                <i class="ki-duotone ki-plus-circle fs-6"></i> Add Role
            </button>
        </div>
    </div>
</div>
