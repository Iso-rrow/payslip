                        ...
                        <div class="col-md-6">
                          ...
                          <!--/////////////////////Document Upload/////////////////////-->
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" name="philhealth_file" class="form-control" accept=".pdf,.jpg,.png,.jpeg">
                            </div>
                            <div class="col-md-6">
    ...
    <div class="modal-content">
      <form id="editEmployeeForm">
        ...
        <div class="modal-body row g-3">
          ...
          <input type="text" id="edit_auto_employee_id" name="auto_employee_id" class="form-control mb-3" readonly>
          ...
          <div class="col-md-12">
                ...
                <input type="file" name="documents[]" id="edit_documents_input" class="form-control mt-2" multiple>
                </div>
