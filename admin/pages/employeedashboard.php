...
<div class="container py-5">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <p><i class="bi bi-person-fill me-2"></i><strong>Name:</strong>
                        <?= htmlspecialchars($credentials['name']) ?></p>
                </div>
                <div class="col-md-6">
                    <p><i class="bi bi-envelope-fill me-2"></i><strong>Email:</strong>
                        <?= htmlspecialchars($credentials['email']) ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header">
            <h5 class="card-title"><i class="bi bi-clock-history me-2"></i>Attendance Records</h5>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-10"><?= htmlspecialchars($row['date']) ?></td>
